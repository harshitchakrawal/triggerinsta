      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10">
        ...
        <div className="w-full max-w-sm">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/60 border border-[#0F0F0F]/[0.1] rounded-full py-3.5 text-sm font-medium text-[#0F0F0F] hover:bg-white/90 transition-all backdrop-blur-sm disabled:opacity-50"
          >
            {googleLoading ? (
          ...
          <p className="text-center text-xs text-[#6B6660] mt-6">
            ...
            <Link href="/login" className="text-[#0F0F0F] font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </div>

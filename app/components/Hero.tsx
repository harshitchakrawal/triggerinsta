...
export default function HeroPage() {
  return (
    <div className="relative bg-[#F4F1EB] text-[#0F0F0F] font-sans overflow-x-hidden">
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t border-[#0F0F0F]/[0.07] bg-[#F4F1EB] px-8 pt-16 pb-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 mb-16">
            ...
            {/* Product */}
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#0F0F0F] mb-4">Product</p>
              <ul className="flex flex-col gap-2.5">
                {["Features", "How it works", "Pricing", "Changelog"].map((l) => (
                  <li key={l}><a href="#" className="text-sm text-[#6B6660] hover:text-[#0F0F0F] transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            ...
            {/* Resources */}
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#0F0F0F] mb-4">Resources</p>
              <ul className="flex flex-col gap-2.5">
                {["Documentation", "Blog", "Tutorials", "Support"].map((l) => (
                  <li key={l}><a href="#" className="text-sm text-[#6B6660] hover:text-[#0F0F0F] transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            ...
            {/* Company */}
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#0F0F0F] mb-4">Company</p>
              <ul className="flex flex-col gap-2.5">
